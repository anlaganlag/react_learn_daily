      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">简单</h2>
            <p className="text-xl text-gray-600">如果你想逃跑，除非你想杀了他，否则你不会出生。
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">初次接触</h4>
              <p className="text-gray-600 text-center">如果他在痛苦中，他会被认为是有帮助的。
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">发现谈话</h4>
              <p className="text-gray-600 text-center">如果他在痛苦中，他会被认为是有帮助的。
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">签约</h4>
              <p className="text-gray-600 text-center">如果他在痛苦中，他会被认为是有帮助的。
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">快速原型</h4>
              <p className="text-gray-600 text-center">如果他在痛苦中，他会被认为是有帮助的。
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">设计阶段</h4>
              <p className="text-gray-600 text-center">如果他在痛苦中，他会被认为是有帮助的。
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">开发 & 发表</h4>
              <p className="text-gray-600 text-center">如果他在痛苦中，他会被认为是有帮助的。
